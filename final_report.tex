...
%
To address these challenges, we explored the use of \gls{RAG} together with \glspl{SLM} as a potential solution to enhance the performance of \glspl{SLM}s
...
%
This research project provided valuable insights into using \gls{SLM} as a promising alternative to \glspl{LLM}s for specialized tasks.
...
Also, the choice of \gls{SLM} over \gls{LLM}s was made to address the computational requirements and privacy concerns associated with \gls{LLM}s,
